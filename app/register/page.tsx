...
import { Scale, Eye, EyeOff, Mail, Lock, User, Building, Phone } from "lucide-react";
      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-muted-foreground">
            Join thousands of legal professionals using LexChronos
          </p>
        </div>
        ...
        <Card>
          <CardHeader className="space-y-1">
            ...
            <CardDescription>
              Create your account and start managing your legal cases efficiently
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="text-center">
          <Card className="bg-primary/5 border-primary/20">
            <CardContent className="pt-6">
              <h3 className="font-semibold mb-2 text-primary">30-Day Free Trial</h3>
              <p className="text-sm text-muted-foreground">
                Start using LexChronos immediately with full access to all features. 
